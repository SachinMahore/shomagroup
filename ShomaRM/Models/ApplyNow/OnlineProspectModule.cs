            ...
            if (model.ID == 0)
            {
                ...
                try
                {
                    if (model != null)
                    {
                        ...
                        htmlbody += "<p style='font-size: 14px; line-height: 21px; text-align: justify; margin: 0;text-indent: 45px;'><br/>Thank you for registering on our fast and easy Leasing Portal!  Your account has been successfully created as follows:</p>";
                        htmlbody += "<p style='font-size: 14px; line-height: 21px; text-align: justify; margin: 0;text-indent: 45px;'><br/>Username : " + model.Email + "</p>";
                        htmlbody += "<p style='font-size: 14px; line-height: 21px; text-align: justify; margin: 0;text-indent: 45px;'><br/>We are excited you are considering us as your place to live.  If you need any assistance in completing your online application or have any questions about our community, </p>";
                        htmlbody += "<p style='font-size: 14px; line-height: 21px; text-align: justify; margin: 0;text-indent: 45px;'><br/>Please feel free to contact us at your convenience. Our contact information with some highlights about our property is shown below. We look forward to serving you.</p>";

                        reportHTML = reportHTML.Replace("[%EmailHeader%]", "Application Submission");
                        reportHTML = reportHTML.Replace("[%EmailBody%]", htmlbody);
