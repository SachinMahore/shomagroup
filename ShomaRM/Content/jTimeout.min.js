    ...
    $.jTimeout.defaults = {
        ...
        onPriorCallback: function (timeout, seconds) {
            $.jAlert({
                'id': 'jTimeoutAlert',
                //'title': '**WARNING**',
                'content': '<span class="custHeading">ARE YOU STILL THERE?</Span></br></br><span class="custTitle">This session is about to expire</span></br><span class="custTitle">due to inactivity, if you want</span></br><span class="custTitle">to extend your session</span></br><span class="custTitle">select continue</span></br><b><span class="jTimeout_Countdown">' + seconds + '</span> seconds!</b></br></br>',
                'theme': 'red',
                'closeBtn': false,
