...
$(document).ready(function () {
    $('#txtApplicantSSNNumber').bind("cut copy paste contextmenu", function (e) {
        ...
        getEncDecValueGuarantor(this, 1);
    }).focusout(function () {
        var ssn = $(this).val();
        if (ssn.length < 9) {
        ...
        if (ssn.length == 9) {
            getEncDecValueGuarantor(this, 2);
    ...
    document.getElementById('fileUploadPaystub').onchange = function () {
        ...
        if (paystubFile.files.length == 1) {
            ...
            if (paystubFileArray.length == 3) {
                paystubFileUploadGuarantor(paystubFileArray);
            }
        }
    ...
    document.getElementById('fileUploadFedral').onchange = function () {
        ...
        if (fedralFile.files.length == 1) {
            ...
            if (fedralFileArray.length == 2) {
                fedralFileUploadGuarantor(fedralFileArray);
            }
        }
    ...
    document.getElementById('fileUploadBankStatement').onchange = function () {
        ...
        if (bankstatementFile.files.length == 1) {
            ...
            if (bankstatementFileArray.length == 3) {
                bankstatementFileUploadGuarantor(bankstatementFileArray);
            }
        }
    ...
    $("#chkNoSSN").on('ifChanged', function (event) {
        ...
        if (checked == true) {
            ...
            getEncDecValueGuarantor("#txtApplicantSSNNumber", 2);
    ...
    getTenantOnlineListGuarantor(tenantOnlineID);
...
var goToStep = function (stepid, id, calldataupdate) {
    ...
    if (stepid == "15") {
        ...
        if (id == "15") {
            ...
            else if ($("#txtAnnualIncome").val() == '0.00') {
                msg += "Please Fill The Annual Income </br>";
            }
            else {
            ...
            if (!$("#txtSupervisiorName").val()) {
                msg += "Please Fill The Supervisor Name </br>";
            }
            if (!$("#txtSupervisiorPhone").val()) {
                msg += "Please Fill The Supervisor Phone </br>";
            }
    ...
    if (stepid == "16") {
        if (parseInt($("#hdnStepCompleted").val()) < 15) {
            var msg = getStepCompletedMsgGuarantor(parseInt($("#hdnStepCompleted").val()) + 1, 16);
            $.alert({
                title: "",
                content: msg,
                type: 'red'
...
var getStepCompletedMsgGuarantor = function (currentstep, clickstep) {
    var stepArray = [{ StepID: 7, StepName: "Applicant" }, { StepID: 9, StepName: "Personal Info" }, { StepID: 11, StepName: "Employment & Income" }, { StepID: 15, StepName: "Summary" }, { StepID: 16, StepName: "Payment" }];
    var clickstepname = "";
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (idmsg[0] != 0) {
                ...
                getApplyNowListGuar(idmsg[0]);
                getTenantOnlineListGuarantor(idmsg[0]);
                getApplicantListsGuarantor(idmsg[0]);
...
var getTransationLists = function (userid) {
    ...
    $.ajax({
        ...
        success: function (response) {
            $("#divLoader").hide();
            $("#tblTransaction_Guarantor>tbody").empty();
            ...
            $.each(response.model, function (elementType, elementValue) {
                ...
                html += "<td>Paid</td>";
                html += "</tr>";
                $("#tblTransaction_Guarantor>tbody").append(html);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if ($.trim(response.error) != "") {
                ...
                addParkingArray = [];
                $("#tblParking_Guarantor>tbody").empty();
                $.each(response, function (index, elementValue) {
                    var html = '';
                    ...
                    $("#tblParking_Guarantor>tbody").append(html);
                });
            }
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if ($.trim(response.error) != "") {
                ...
                addStorageArray = [];
                $("#tblStorage1_Guarantor>tbody").empty();
                $.each(response, function (index, elementValue) {
                    var html = '';
                    ...
                    $("#tblStorage1_Guarantor>tbody").append(html);
                });
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if ($.trim(response.error) != "") {
                ...
                addPetPlaceArray = [];
                $("#tblPetPlace_Guarantor>tbody").empty();
                $.each(response, function (index, elementValue) {
                    var html = '';
                    ...
                    $("#tblPetPlace_Guarantor>tbody").append(html);
                });
            }
        }
    });
...
var goToEditApplicantGuarantor = function (aid) {
    clearApplicant();
    if (aid != null) {
        //sacxhis
...
var getApplicantListsGuarantor = function () {
    ...
    $.ajax({
        ...
        totpaid = 0;
        totnotpaid = 0;
        $("#tblApplicant_Guarantor").empty();
        $("#tblApplicant15_Guarantor>tbody").empty();
        $("#tblApplicant15p_Guarantor>tbody").empty();
        $("#tblRespo15_Guarantor>tbody").empty();
        $("#tblRespo15p_Guarantor>tbody").empty();
        $("#tblApplicantFinal_Guarantor").empty();
        $("#tblApplicantMinor_Guarantor").empty();
        $("#tblApplicantGuarantor_Guarantor").empty();
        $("#tblResponsibilityPay_Guarantor>tbody").empty();
        $("#tblPayment_Guarantor>tbody").empty();
        $("#tblEmailCoapplicant_Guarantor>tbody").empty();
        ...
        $.each(response.model, function (elementType, elementValue) {
            ...
            if (elementValue.Type == "Guarantor") {
                if (elementValue.CreditPaid == "1") {
                    ...
                    pprhtml += "<tr data-id='" + elementValue.ApplicantID + "'><td style='width:18%; padding:6px;'>Credit Check Fees</td><td style='width:20%; padding:6px;'> </td><td style='width:14%; padding:6px;'>$" + parseFloat(elementValue.GuarCreditFees).toFixed(2) + "</td><td style='width:14%; padding:6px;text-align: center;'>Paid</td><td></td></tr>";
            ...
            if (elementValue.Type == "Minor") {
                $("#tblApplicantMinor_Guarantor").append(html);
            }
            else if (elementValue.Type == "Guarantor") {
                $("#tblApplicantGuarantor_Guarantor").append(html);
            }
            else {
                $("#tblApplicant_Guarantor").append(html);
                $("#tblApplicantFinal_Guarantor").append(html);
            }
            ...
            html15 += "</tr>";
            $("#tblApplicant15_Guarantor>tbody").append(html15);
            $("#tblApplicant15p_Guarantor>tbody").append(html15);
            ...
            htmlResp15 += "</tr>";
            $("#tblRespo15_Guarantor>tbody").append(htmlResp15);
            $("#tblRespo15p_Guarantor>tbody").append(htmlResp15);

            $("#tblResponsibilityPay_Guarantor>tbody").append(prhtml);
            $("#tblPayment_Guarantor>tbody").append(pprhtml);
            $("#tblEmailCoapplicant_Guarantor>tbody").append(emailhtml);
...
var getPetLists = function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            $("#divLoader").hide();
            $("#tblPet_Guarantor>tbody").empty();
            $("#tblPet15_Guarantor>tbody").empty();
            $("#tblPet15p_Guarantor>tbody").empty();
            $.each(response.model, function (elementType, elementValue) {
                ...
                html += "</td >";
                html += "</tr>";
                $("#tblPet_Guarantor>tbody").append(html);
                ...
                $("#tblPet15_Guarantor>tbody").append(html15);
                $("#tblPet15p_Guarantor>tbody").append(html15);
...
var getVehicleLists = function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            $("#divLoader").hide();
            $("#tblVehicle_Guarantor>tbody").empty();
            $("#tblVehicle15_Guarantor>tbody").empty();
            $("#tblVehicle15p_Guarantor>tbody").empty();
            var noofveh = 0;
            $.each(response.model, function (elementType, elementValue) {
                ...
                html += "</tr>";
                $("#tblVehicle_Guarantor>tbody").append(html);
                ...
                html15 += "</tr>";
                $("#tblVehicle15_Guarantor>tbody").append(html15);
                $("#tblVehicle15p_Guarantor>tbody").append(html15);
                noofveh += 1;
            });
            if (noofpark == noofveh) {
...
var saveupdateTenantOnlineGuarantor = function (stepcompleted) {
    var msg = "";
    var ProspectID = $("#hdnOPId").val();
...
var getFillSummaryGuar = function (id) {
...
var getTenantOnlineListGuarantor = function (id) {
    $("#divLoaderFullData").show();
    var model = {
        id: id
    };
...
function saveupdatePaymentResponsibility(stepcompleted) {
    $("#divLoader").show();
    var model = new Array();
    $("#tblResponsibilityPay_Guarantor TBODY TR").each(function () {
        var row = $(this);
        var customer = {};
...
var getApplicantHistoryList = function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#tblAHR_Guarantor>tbody").empty();
            $("#prevadd_Guarantor>tbody").empty();
            $("#prevaddp_Guarantor>tbody").empty();
            $.each(response.model, function (elementType, elementValue) {
                ...
                $("#tblAHR_Guarantor>tbody").append(html);
...
var getTenantPetPlaceData = function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var rowCount = $("#tblPet_Guarantor >tbody").children().length;
...
var saveEmployerHistory = function () {
    ...
    if (!supervisorPhoneHei) {
        msg += 'Please Fill SupervisorPhone</br>';
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.model, function (elementType, elementValue) {
                ...
                html += "</tr>";
                $("#tblHEI_Guarantor>tbody").append(html);
...
var getPreviousAddressInfoGuar = function (id) {
    $("#divLoaderFullData").show();
    var model = {
        id: id
    };
...
var getPreviousEmployementInfoGuar = function (id) {
    $("#divLoaderFullData").show();
    var model = {
        id: id
    };
...
var printSummary = function () {
    ...
    $.ajax({
        url: '/ApplyNow/PrintGuarantorForm',
        type: "post",
        contentType: "application/json utf-8",
        data: JSON.stringify(model),
        dataType: "JSON",
...
var getEncDecValueGuarantor = function (txtBox, encdec) {
    var encdecval = "";
    if (encdec == 1) {
...
var paystubFileUploadGuarantor = function (pArray) {
    $("#divLoader").show();
    $formData = new FormData();
...
var fedralFileUploadGuarantor = function (fArray) {
    $("#divLoader").show();
    $formData = new FormData();
...
// New Paystub file Upload Method
var bankstatementFileUploadGuarantor = function (bsArray) {
    $("#divLoader").show();
    $formData = new FormData();
