    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response.model, function (elementType, elementValue) {
                ...
                html += "<td><a href='javascript:void(0);' onclick='editPaymentAccounts(" + elementValue.PAID + ")' " + cla + "><img class='m-r20 ml-10' src='/Content/assets/img/icon/pencil.png'/></a>  <a href='javascript:void(0);' onclick='deletePaymentAccounts(" + elementValue.PAID + ")' " + cla + "><img src='/Content/assets/img/icon/Cancel.png'/></a></td>";
                ...
                $.each(response, function (elementType, elementValue) {
                    ...
                    if (elementValue.Status == "Cancelled") {
                        ...
                        if (elementValue.calculatedDate <= dateC) {
                            html += "<td onclick='cancleRequest(" + elementValue.ARID + ")' style='cursor:pointer;'><a><img src='/Content/assets/img/icon/Cancel.png'/></a></td>";
                        }
                        else {
                            html += "<td onclick='cancleRequest(" + elementValue.ARID + ")' style='cursor:pointer;'><a><img src='/Content/assets/img/icon/Cancel.png'/></a></td>";
                        }
