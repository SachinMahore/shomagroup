...
$(document).ready(function () {
    ...
    document.getElementById('fileUploadPaystub').onchange = function () {
        ...
        if (paystubFile.files.length == 1) {
            ...
            if (paystubFileArray.length == 3) {
                paystubFileUploadCoapplicant(paystubFileArray);
            }
        }
    ...
    document.getElementById('fileUploadFedral').onchange = function () {
        ...
        if (fedralFile.files.length == 1) {
            ...
            if (fedralFileArray.length == 2) {
                fedralFileUploadCoapplicant(fedralFileArray);
            }
        }
    ...
    document.getElementById('fileUploadBankStatement').onchange = function () {
        ...
        if (bankstatementFile.files.length == 1) {
            ...
            if (bankstatementFileArray.length == 3) {
                bankstatementFileUploadCoapplicant(bankstatementFileArray);
            }
        }
    ...
    $("#chkNoSSN").on('ifChanged', function (event) {
        ...
        if (checked == true) {
            ...
            getEncDecValueCoApplicant("#txtApplicantSSNNumber", 2);
...
var saveupdateParkingCoApplicant = function () {
    //$("#divLoader").show();
    //var tenantID = $("#hdnOPId").val();
    //var uid = $("#hndUID").val();
...
var paystubFileUploadCoapplicant = function (pArray) {
    $("#divLoader").show();
    $formData = new FormData();
...
var fedralFileUploadCoapplicant = function (fArray) {
    $("#divLoader").show();
    $formData = new FormData();
...
// New Paystub file Upload Method
var bankstatementFileUploadCoapplicant = function (bsArray) {
    $("#divLoader").show();
    $formData = new FormData();
